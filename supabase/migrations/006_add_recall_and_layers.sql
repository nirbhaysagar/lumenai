-- Migration: Add Recall and Layers
-- Description: Adds layer column to chunks and creates tables for concepts, recall, and memory strength.

-- 1. Add layer column to chunks
ALTER TABLE chunks ADD COLUMN IF NOT EXISTS layer text default 'raw'; -- 'raw', 'canonical', 'abstract'

-- 2. Concepts (Layer 3: Abstract Knowledge)
...
-- 4. Concept <-> Chunk Mapping (Grounding)
...
-- 5. Recall Items (Active Recall Requests)
...
-- 6. Memory Strength (Spaced Repetition Data)
